...
const TOKEN_COOKIE_NAME = "NFTS_Token";
const API_SECRET = process.env.API_SECRET_KEY;

// using example code from lecture 21 
...
exports.generateToken = (req, res, user) => {
  ...
  res.cookie(TOKEN_COOKIE_NAME, token, {
    httpOnly: true,
    secure: true,
    maxAge: 30 * 60 * 1000 //This session expires in 30 minutes.. but token expires in 1 hour!
  });
};
...
exports.removeToken = (req, res) => {
  ...
  res.cookie(TOKEN_COOKIE_NAME, "", {
    httpOnly: true,
    secure: true,
    maxAge: -30 * 60 * 1000 //This session expired 30 minutes ago
  });
};
